...
import com.heyongrui.iflytek.speech.util.XmlParser;
...
//				mAsr.setParameter(SpeechConstant.SAMPLE_RATE, "8000");
            ...
            // 停止识别
        } else if (i == R.id.isr_stop) {
            mAsr.stopListening();
            showTip("停止识别");
            // 取消识别
        } else if (i == R.id.isr_cancel) {
            mAsr.cancel();
            showTip("取消识别");
        }
    }
