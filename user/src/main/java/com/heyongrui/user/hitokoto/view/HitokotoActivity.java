package com.heyongrui.user.hitokoto.view;
...
import com.heyongrui.user.hitokoto.presenter.HitokotoPresenter;

import java.util.Random;

@Route(path = ConfigConstants.PATH_HITOKOTO)
public class HitokotoActivity extends BaseActivity<HitokotoPresenter> implements HitokotoContract.View {
