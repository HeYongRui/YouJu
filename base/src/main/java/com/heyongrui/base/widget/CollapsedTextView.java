...
public class CollapsedTextView extends AppCompatTextView implements View.OnClickListener {
    ...
    public void setExpandedText(String expandedText) {
        this.mExpandedText = TextUtils.isEmpty(expandedText) ? getContext().getString(R.string.unfold) : expandedText;
    }
    ...
    public void setCollapsedText(String collapsedText) {
        this.mCollapsedText = TextUtils.isEmpty(collapsedText) ? getContext().getString(R.string.collapse) : collapsedText;
    }
    ...
    public CharSequence trimFrom(CharSequence sequence) {
